...
if data.raw["technology"]["tree-seeding"] then --Removed vanilla/wood-gasification recipes from tree seeding, then deletes the tech if no other mods add recipes to the tech.
