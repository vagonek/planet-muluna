...
local function get_decal_pictures(file_path, size_class, image_size, amount, tint, tint_as_overlay, scale)
  local pictures  = {}
...
{
  {
    ...
    pictures = spritesheet_variations(30, 10, {
      filename = "__muluna-graphics__/graphics/decorative/low-density-space-platform-decorative/space-platform-decorative-tiny.png",
      width = 37,
      height = 37,
      scale = 0.5
    })
  ...
  {
    name = "low-density-space-platform-decorative-1x1",
    type = "optimized-decorative",
    ...
    pictures = spritesheet_variations(51, 10, {
      filename = "__muluna-graphics__/graphics/decorative/low-density-space-platform-decorative/space-platform-decorative-1x1.png",
      width = 74,
      height = 74,
      scale = 0.5
    })
  ...
  {
    name = "low-density-space-platform-decorative-2x2",
    type = "optimized-decorative",
    order = "b[decorative]-b[space-platform-decal]-d[2x2]",
    collision_box = {{-0.9, -0.9}, {0.9, 0.9}},
    minimal_separation = 0.8,
    target_count = 5,
    render_layer = render_layer[6],
    pictures = spritesheet_variations(4, 4, {
      filename = "__muluna-graphics__/graphics/decorative/low-density-space-platform-decorative/space-platform-decorative-2x2.png",
      width = 150,
      height = 150,
      scale = 0.5
    })
  ...
  {
    name = "low-density-space-platform-decorative-4x4",
    type = "optimized-decorative",
    order = "b[decorative]-b[space-platform-decal]-c[4x4]",
    collision_box = {{-1.9, -1.9}, {1.9, 1.9}},
    minimal_separation = 4.0,
    target_count = 2,
    render_layer = render_layer[5],
    pictures = spritesheet_variations(7, 4, {
      filename = "__muluna-graphics__/graphics/decorative/low-density-space-platform-decorative/space-platform-decorative-4x4.png",
      width = 300,
      height = 300,
      scale = 0.5
    })
  ...
  {
    name = "low-density-space-platform-decorative-pipes-1x1",
    type = "optimized-decorative",
    ...
    pictures =  spritesheet_variations(24, 12, {
      filename = "__muluna-graphics__/graphics/decorative/low-density-space-platform-decorative/space-platform-decorative-pipes-1x1.png",
      width = 64,
      height = 64,
      scale = 0.5
    })
  ...
  {
    name = "low-density-space-platform-decorative-pipes-1x2",
    type = "optimized-decorative",
    order = "b[decorative]-b[space-platform-decal]-b[pipe-1x2]",
...
,
    ...
    pictures =  spritesheet_variations(9, 9, {
      filename = "__muluna-graphics__/graphics/decorative/low-density-space-platform-decorative/space-platform-decorative-pipes-1x2.png",
      width = 64,
      height = 128,
      scale = 0.5
    })
  ...
  {
    name = "low-density-space-platform-decorative-pipes-2x1",
    type = "optimized-decorative",
    ...
    pictures = spritesheet_variations(7, 7, {
      filename = "__muluna-graphics__/graphics/decorative/low-density-space-platform-decorative/space-platform-decorative-pipes-2x1.png",
      width = 128,
      height = 64,
      scale = 0.5
    })
