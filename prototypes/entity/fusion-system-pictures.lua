...
local function generator_pictures(direction)
  ...
  return
  {
    layers =
    {
      util.sprite_load("__muluna-graphics__/graphics/entities/advanced-steam-turbine/advanced-steam-turbine-" .. direction,
      {
        priority = "high",
        frame_count = 6,
        scale = 0.5,
      }),
      util.sprite_load("__muluna-graphics__/graphics/entities/advanced-steam-turbine/advanced-steam-turbine-" .. direction .. "-shadow",
      {
        priority = "high",
        draw_as_shadow = true,
        frame_count = 1,
...
local function generator_working_light(direction, fluid_input)
  ...
  local sprite = util.sprite_load("__muluna-graphics__/graphics/entities/advanced-steam-turbine/advanced-steam-turbine-" .. direction .. "-mask",
  {
    priority = "high",
    blend_mode = "additive",
    draw_as_glow = true,
...
return
{
  ...
  {
    --glow_color = {1,0,0.4,1}, --default of fusion generator
    glow_color = {156,122,28,0}, --Yellow glow, no alpha
    north_graphics_set =
    {
